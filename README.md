...
- **use_cases/**: Real-world production examples (customer support, research assistant, code reviewer).
- **testing/**: Testing examples with pytest.
- **integrations/**: FastAPI and Slack bot examples.
